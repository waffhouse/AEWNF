...
>
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
            ...
            <div class="bg-gray-900 px-4 py-4 sm:px-6">
                <div class="flex justify-between items-start">
                    <div>
                        <div class="flex items-center">
                            ...
                            <h3 class="text-lg leading-6 font-bold text-red-400" id="modal-title">
                                Order #{{ $order->id }} Details
                            </h3>
                        </div>
                        
                        <div class="flex items-center mt-2">
                            <p class="text-sm text-white mr-3">Placed on @formatdate($order->created_at)</p>
                            
                            @if($order->status === \App\Models\Order::STATUS_PENDING)
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 border border-yellow-200 shadow-sm">
