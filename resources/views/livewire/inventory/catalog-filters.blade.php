    ...
    <div class="mb-6 border border-gray-200 rounded-lg p-4 bg-gray-50 shadow-sm">
        ...
        <div class="mt-4 flex flex-col sm:flex-row gap-2 items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                <!-- Clear Cart Button (only shown for authenticated users) -->
                @auth
                    @can('add to cart')
                        <button 
                            type="button"
                            ...
                            class="px-4 py-2 text-sm font-medium text-red-700 bg-white border border-red-200 rounded-md shadow-sm hover:bg-red-50 focus:outline-none focus:ring-0 flex items-center"
