...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-20 sm:pt-24 bg-gray-100">
            ...
            <div class="w-full sm:max-w-md px-8 py-6 bg-white shadow-lg overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
